...
namespace BanKai.Basic
{
    ...
    public class Enumkeys
    {
        ...
        {
            const bool bottomEqualsLeft = BorderSide.Bottom == BorderSide.Left;//默认从0开始，1递增
        ...
        public void should_increase_the_integer_automatically()
        {
            ...
            // 如果不为枚举数列表中的元素指定值，则它的第一个默认值为0，它们的值将以 1 为增量自动递增。
        ...
        public void should_be_able_to_parse_enum_by_value()
        {
            ...
            // change the variable value to fix the test.
            Console.WriteLine(parsedBottomEnumValue);

            const BorderSide expectedEnumValue = BorderSide.Right;
