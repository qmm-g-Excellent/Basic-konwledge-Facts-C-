...
namespace BanKai.Basic
{
    public class ArrayOperations
    {
        ...
        public void should_throw_if_index_is_out_of_range()
        {
            ...
            Assert.Throws(expectedExceptionType, () => array[99]);//下标溢出
        }
        ...
        {
            var array = new[] {new RefTypeClass(1)};//数组array里面存储的引用

            //需要使用强制类型转换，原因在于Clone()返回的类型为Object
            ...
            //cloned时复制的数组的内容，单纯的拷贝，存储在新的内存中
