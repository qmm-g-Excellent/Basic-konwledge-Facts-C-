...
namespace BanKai.Basic
{
    ...
    public class VariablesAndParameters
    {
        ...
        public void should_get_copy_of_the_argument_when_passing_by_value_for_value_type()
        {
            ...
            FunctionPassingIntAsArgument(passingInt);//传递参数时，是拷贝一份新的内存
        ...
        public void should_get_copy_of_the_argument_when_passing_by_value_for_ref_type()
        {
            ...
            // change the variable value to correct one.
            RefTypeClass expectedResult = refTypeObject;// my:new RefTypeClass(2); 拷贝一份新的引用，但是是同一个地址
        ...
        public void should_ref_to_same_location_when_passing_by_ref_for_value_type()
        {
            ...
            FunctionPassingRefIntAsArgument(ref passingInt);//操作的同一个引用
        ...
        public void should_ref_to_same_location_when_passing_by_ref_for_ref_type()
        {
            ...
            RefTypeClass modifiedRefTypeObject = FunctionPassingRefRefTypeClassAsArgument(ref refTypeObject);
        ...
        public void should_ref_to_same_location_when_passing_by_out_for_value_type()
        {
            ...
            FunctionPassingOutIntAsArgument(out passingInt);//out一定要初始化，一定会返回这个变量
        ...
        {
            // 这里是有默认参数的，不传递参数时使用该参数，  这里并不是重载，只是一个语法糖！！
            return value;
        }

        private static int PassVariableLengthArguments(params int[] values)
        {   //params可以传递可变参数，只能有一个，如果有多个参数，params必须放在最后一个位置
        ...
        private RefTypeClass FunctionPassingRefRefTypeClassAsArgument(ref RefTypeClass refTypeObject)
        {
        ...
        private static RefTypeClass FunctionPassingRefTypeClassAsArgument(RefTypeClass refTypeObject)
        {
            refTypeObject = new RefTypeClass(2);
            return refTypeObject;
        }
